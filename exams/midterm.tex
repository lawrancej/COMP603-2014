...
\part The set of terminals appearing first in any string derived from a nonterminal \answerline
...
\part Nonterminals to derive sequences of terminals and nonterminals. \answerline % D
