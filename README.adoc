...
. Flesh out the things you expect to implement (your goals) in your project's README file somewhere.
. Use the issue tracker to assign tasks to folks on your team.

*Hint*: Please don't start from scratch if possible. Try to leverage something that already exists, because it'll be more impressive in the end.
