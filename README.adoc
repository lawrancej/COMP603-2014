...
== June 16
image:https://raw.githubusercontent.com/lawrancej/COMP603-2014/master/scribbles/june-16.png[See this image].

See the state machine at the top.
...
See the circles in the middle. Assume these are levels of the Chomsky hierarchy. Fill them in.

See the grammar at the bottom.
