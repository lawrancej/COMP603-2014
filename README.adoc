...
NOTE: The real midterm will consist of *extremely short* answers (not sentences), but the content will be similar.

=== Form teams
And meet with them. 

TIP: Shoot me an email if you'd like me to send you a list of students interested in the same projects as you.
