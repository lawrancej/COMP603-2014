...
These are traditional project ideas that you're welcome to pursue:
...
* Something like Quickcheck, or something that can generate characterization tests automatically.
