...
=== Lab 4
Optimize your compiler and interpreter developed in Lab 3. (Think Run-length encoding your brainfuck code).
...
=== Symbol tables
A map from an identifier within a scope to information about it (its type, where it's defined).
